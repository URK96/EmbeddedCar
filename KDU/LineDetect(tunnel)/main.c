...
void* tunnelThread(void *arg)
{
   ...
   int angle_r = 1400;
	...
	if(distance[1] > distance[5] /*&& distance[2] > distance[4]*/){

	SteeringServoControl_Write(angle_l);
    }
	else if(distance[1] < distance[5]/* && distance[2] < distance[5]*/){
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    	ret = pthread_create(&tdata.threads[5], NULL, tunnelThread, &tdata);
    	if(ret) {
